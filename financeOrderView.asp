...
<title>Finance order view</title>
...
'This SQL statement is selecting the TeacherID from the table tblOrder where the OrderID from the homepage is equal to the OrderID from the table.
sql = "SELECT TeacherID FROM tblOrder WHERE OrderID = " & request.QueryString("OrderID")

rs.Open sql, Con

'The TeacherID that's from the table tblOrder is assigned to the variable TeacherID.
...
If rs("ChequeNumber") <> "0" Then
		response.redirect("alreadyOrderedF.asp")
End if
...
<div align="center">
  <table width="126" border="1">
    <tr>
      <td width="169">
        <div class="box"> 
        	<div align="center"><a href="displayFinanceHomepage.asp"><strong>HOMEPAGE</strong></a></div>
        </div>
      </td>
    </tr>
  </table>
...
<table width="312" border="1" align="center">
      ...
      <tr>
        ...
        <p>&nbsp;</p>
        <div class="submitBox" align="center"> 
        	<div align="center"><a href="updateOrderView.asp?OrderID=<%=request.Querystring("OrderID")%>"><strong>SUBMIT</strong></a>
        </div>
</div>
